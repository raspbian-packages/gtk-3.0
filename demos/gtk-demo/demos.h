...
Demo gtk_demos[] = {
  { "Application class", "application.c", do_application, NULL }, 
  { "Application window", "appwindow.c", do_appwindow, NULL }, 
  ...
  { "Overlay", "overlay.c", do_overlay, NULL }, 
  ...
  { "Transparent", "transparent.c", do_transparent, NULL }, 
