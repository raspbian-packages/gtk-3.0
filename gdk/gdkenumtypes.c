...
gdk_device_pad_feature_get_type (void)
{
    ...
    if (G_UNLIKELY(etype == 0)) {
        ...
        etype = g_enum_register_static (g_intern_static_string ("GdkDevicePadFeature"), values);
    }
    return etype;
}
...
gdk_device_tool_type_get_type (void)
{
    ...
    if (G_UNLIKELY(etype == 0)) {
        ...
        etype = g_enum_register_static (g_intern_static_string ("GdkDeviceToolType"), values);
    }
    return etype;
}
...
gdk_drag_cancel_reason_get_type (void)
{
    ...
    if (G_UNLIKELY(etype == 0)) {
        ...
        etype = g_enum_register_static (g_intern_static_string ("GdkDragCancelReason"), values);
    }
    return etype;
}
GType
...
gdk_seat_capabilities_get_type (void)
{
    ...
    if (G_UNLIKELY(etype == 0)) {
        ...
        etype = g_flags_register_static (g_intern_static_string ("GdkSeatCapabilities"), values);
    }
    return etype;
}
...
gdk_axis_flags_get_type (void)
{
    ...
    if (G_UNLIKELY(etype == 0)) {
        ...
        etype = g_flags_register_static (g_intern_static_string ("GdkAxisFlags"), values);
    }
    return etype;
}
...
gdk_anchor_hints_get_type (void)
{
    ...
    if (G_UNLIKELY(etype == 0)) {
        ...
        etype = g_flags_register_static (g_intern_static_string ("GdkAnchorHints"), values);
    }
    return etype;
}
GType
