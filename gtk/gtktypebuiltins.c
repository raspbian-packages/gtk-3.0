...
gtk_application_inhibit_flags_get_type (void)
{
    ...
    if (G_UNLIKELY(etype == 0)) {
        ...
        etype = g_flags_register_static (g_intern_static_string ("GtkApplicationInhibitFlags"), values);
    }
    return etype;
}
...
gtk_input_purpose_get_type (void)
{
    ...
    if (G_UNLIKELY(etype == 0)) {
        ...
        etype = g_enum_register_static (g_intern_static_string ("GtkInputPurpose"), values);
    }
    return etype;
}
GType
...
gtk_popover_constraint_get_type (void)
{
    ...
    if (G_UNLIKELY(etype == 0)) {
        ...
        etype = g_enum_register_static (g_intern_static_string ("GtkPopoverConstraint"), values);
    }
    return etype;
}
...
gtk_pad_action_type_get_type (void)
{
    ...
    if (G_UNLIKELY(etype == 0)) {
        ...
        etype = g_enum_register_static (g_intern_static_string ("GtkPadActionType"), values);
    }
    return etype;
}
...
gtk_shortcut_type_get_type (void)
{
    ...
    if (G_UNLIKELY(etype == 0)) {
        ...
        etype = g_enum_register_static (g_intern_static_string ("GtkShortcutType"), values);
    }
    return etype;
}
...
gtk_style_context_print_flags_get_type (void)
{
    ...
    if (G_UNLIKELY(etype == 0)) {
        ...
        etype = g_flags_register_static (g_intern_static_string ("GtkStyleContextPrintFlags"), values);
    }
    return etype;
}
